...
def create_history_plot_accuracy(history, model_name, metrics=None):
...
def plot_history(history, model_name):
    create_history_plot_accuracy(history, model_name)
    create_history_plot_loss(history, model_name)
    plt.show()
